...
const EditProperty = () => {
    ...
    return (
        <main className='max-w-md mx-auto p-10 shadow-xl mt-10'>
            ...
            <button type='submit' className='mb-6 w-full px-7 py-3 bg-[#ce6c10] text-white font-medium text-sm uppercase rounded shadow-md hover:bg-[#BD5B00] hover:shadow-lg focus:bg-blue-700 focus:shadow-lg active:bg-[#8a4300] active:shadow-lg transition duration-150 ease-in-out'>Save Edit</button>
        </form>
        </main>
    )
}
